...
**班次判定规则**：名单内的人永远标夜班；其他人按其在报表窗口内的分配时间落在哪个
「独家时段」投票——上午（约 08:10-13:10）投白班、晚间（18:00-23:00）投中班、
深夜投夜班，得票多者胜出；13:30-17:30 白/中交叉时段不投票。这样即使有人提前
20 分钟接单也能正确归类，且同一个人的所有记录班次标注一致。
